...
Welcome to BitDoge: I want this token to be fully supported by the community and to be like bitcoin used to be. (aamiin)

THIS CONTRACT IS MADE FOR THE COMMUNITY IT HAS THE FEATURES FOR A FUCKING MOON BUT YOU HAVE TO WORK FOR YOUR BAGS
I ONLY PROVIDE TOKEN + INITIAL LIQUIDITY, LIQ WILL BE LOCKED.

Buy BitDoge for the future, Stay around and watch the ride…

https://t.me/bitdogecommunity

BITDOGECHAIN  - BITDOGE

Total Supply: 21,000,000 
Max Wallet: 2% (420,000 Tokens) 
Max Sell: 1% (210,000 Tokens) 
Buy / Sell Tax: 0% 
...
library Address{
 ...
 contract BDMAX is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 21_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 21_000_000 * 10**18;
    uint256 public maxBuyLimit = 420_000 * 10**18;
    ...
    constructor (address routerAddress) {
        IDogeSwapV2Router02 _router = IDogeSwapV2Router02(routerAddress);
        address _pair = IDogeSwapV2Factory(_router.factory())
            .createPair(address(this), _router.WWDOGE());
    ...
    function updateRouterAndPair(address newRouter, address newPair) external onlyOwner{
        router = IDogeSwapV2Router02(newRouter);
        pair = newPair;
    }
